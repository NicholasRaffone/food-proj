const Bib = () => {
    return(
        <div className="pt-24 pb-5 px-6 md:px-24 min-h-screen bg-[#181818] overflow-hidden">
            ...
            <p className="text-white py-3">
                Amick, Brian. “Yelp Releases Black-Owned Businesses ‘Ones to Watch’ in Food for 2022.” Bakemag, Bake Magazine, 7 Feb. 2022,  
            ...
            <p className="text-white py-3">
                de León, Riley. “Black-Owned Restaurants in NYC Struggle for Survival as Stimulus Stalemate Drags On.” CNBC, CNBC, 23 Oct. 2020,
                &nbsp;<a href="https://www.cnbc.com/2020/10/23/black-owned-restaurants-struggle-for-survival-as-a-stimulus-stalemate-carries-on.html" target="_blank" rel="noreferrer" className="underline">Link</a>.  
            </p>
            <p className="text-white py-3">
                “How You Can Support Black-Owned Restaurants.” Cuboh,
                &nbsp;<a href="https://www.cuboh.com/blog/why-supporting-black-owned-restaurants-helps" target="_blank" rel="noreferrer" className="underline">Link</a>.   
            </p>
            <p className="text-white py-3">
                Kang, Anna. “Supporting Black-Owned Businesses Should Be More than Just a Trend.” Forbes, Forbes Magazine, 9 Sept. 2020,
                &nbsp;<a href="https://www.forbes.com/sites/annakang/2020/09/08/supporting-black-owned-businesses-should-be-more-than-just-a-trend/?sh=4b1b52597df4" target="_blank" rel="noreferrer" className="underline">Link</a>.    
            </p>
            <p className="text-white py-3">
                Malik, Noorie. “New Consumer Alert on Yelp Takes Firm Stance against Racism.” Yelp, 7 Sept. 2021,
